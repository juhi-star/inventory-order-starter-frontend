...
export function DeleteCustomerDialog({ customer, isDeleting, onConfirm, onClose }) {
  return (
    _jsxDEV(Dialog, { open: customer !== null, onOpenChange: (open) => (!open ? onClose() : null), children: 
      _jsxDEV(DialogContent, { className: "sm:max-w-sm", children: [
        _jsxDEV(DialogHeader, { children: [
          _jsxDEV(DialogTitle, { children: "Delete customer?" }, void 0, false, {fileName: _jsxFileName, lineNumber: 24}, this)
          , _jsxDEV(DialogDescription, { children: 
            customer ? `"${customer.full_name}" (${customer.email}) will be removed.` : ""
